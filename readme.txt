...
(done, but need to improve toString for prettier output)	Рекурсивный парсинг вложенных тэгов : к имени-значению объекта/кортежа добавляется опциональное поле - коллекция вложенных тегов)
